...
from declarations.properties_specials import XPOS, ZPOS, LINKTRID, \
    MCUTIMER, MCUBEHAVIOUR, MCUCTRIGGER, YPOS, COUNTRY, TIME, \
    ENABLED, MCUDEACTIVATE, MCUACTIVATE, EVENTENTER
from declarations.template_declaration import BEHDEACTALL, SETCOUNTRY, TEMPLATECTRIGGER, CTRIGGERNAME, BEHAVAFNAME, AFTIMERNAME, TEMPLATEDEACTIVATE, \
